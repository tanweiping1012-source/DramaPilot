...
test("native dialogue change invalidates its video; unrelated character stays reusable", () => {
    ...
    assert.deepEqual(invalidatedArtifacts(a, { kind: "character", id: "elder", revision: 2 }, "separate"), ["s1", "s3"]);
    assert.deepEqual(invalidatedArtifacts(a, { kind: "line", id: "l1", revision: 2 }, "native"), ["s1", "s3"]);
    assert.deepEqual(invalidatedArtifacts(a, { kind: "line", id: "l1", revision: 2 }, "separate"), []);
});
