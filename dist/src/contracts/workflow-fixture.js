import { WORKFLOW_DRAFT_VERSION as version, revisionRef as ref, workflowHash, validateSourceAssetPackage, validateTargetStoryboard, validatePrevisArtifact, validateProductionPackage, validateUntrustedConfirmation, StagePlanSchema, } from "./workflow-draft.js";
...
export function makeWorkflowDraftFixture() {
    ...
    const characters = [
        { kind: "target_character", id: "host", revision: 1, source_character_ids: ["elder"], design: "虚构成年家族主人，晚宴正装", rationale: "保留掌权者功能" },
        { kind: "target_character", id: "guest", revision: 1, source_character_ids: ["outsider"], design: "虚构成年姻亲，晚宴正装", rationale: "保留被排斥者功能" },
    ];
    const scene = { kind: "target_scene", id: "dinner", revision: 1, source_scene_ids: ["hall"], design: "家族私人晚宴", rationale: "以座位资格表达家族排斥" };
    const prop = { kind: "target_prop", id: "chair", revision: 1, source_prop_ids: ["door"], design: "被收走的餐椅", rationale: "阻拦入席" };
    const line = { kind: "target_line", id: "l1", revision: 1, source_dialogue_ids: ["d1"], speaker_character_id: "host", text: "That doesn't give you a seat at this table.", rationale: "保留排斥含义" };
    ...
    const previs = [sourcePrevis, ...targetPrevis];
